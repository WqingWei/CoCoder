...
class Pico:
    def __init__(
        ...
        self.run_store = run_store or RunStore(Path(workspace.repo_root) / ".cocoder" / "runs")
    ...
    def build_prefix(self):
        ...
        text = textwrap.dedent(
            f"""\
            You are cocoder, a small local coding agent working inside a local repository.
