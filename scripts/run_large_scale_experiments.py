...
from cocoder.metrics import (  # noqa: E402
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Run cocoder large-scale experiments and write all experiment artifacts.")
